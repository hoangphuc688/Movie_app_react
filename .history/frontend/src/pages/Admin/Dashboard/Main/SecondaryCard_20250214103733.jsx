...
SecondaryCard.propTypes = {
  ...
  content: PropTypes.string.isRequired, // `title` bắt buộc phải có
  info: PropTypes.string, // Kiểu dữ liệu của `pill` là string
  gradient: PropTypes.string.isRequired, // `title` bắt buộc phải có
